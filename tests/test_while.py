...
def test_while_task(decorated_add, decorated_smaller_than):
    ...
    def raw_python_code():
        n01 = decorated_add._callable(1, 1)
        m = 1
        n = n01
        l1 = 1
        while m < 10:
            n11 = decorated_add._callable(1, 1)
            print('n11', n11)
            while n < 5:
                n21 = decorated_add._callable(n, n11)
                n22 = decorated_add._callable(n21, 1)
                n = n22
                print('n21', n21)
                print('n22', n22)
            niter = 0
            while l1 < 5 and niter < 1:
                n31 = decorated_add._callable(l1, 1)
                n32 = decorated_add._callable(n31, 1)
                l1 = n32
                niter += 1
                print('n31', n31)
                print('n32', n32)
            n12 = decorated_add._callable(m, n32)
            print('n12', n12)
            m = n12

        m = decorated_add._callable(m, n31)
        return m
    ...
    while1 = wg.add_task(TaskPool.workgraph.while_zone, name='while1', conditions=compare1.outputs.result)
    ...
    while2 = wg.add_task(TaskPool.workgraph.while_zone, name='while2', conditions=compare2.outputs.result)
