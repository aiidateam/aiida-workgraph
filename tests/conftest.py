...
def decorated_add() -> Callable:
    ...
    @task.calcfunction()
    def add(x: Union[int, float], y: Union[int, float], t: Union[int, float] = 1.0) -> Union[int, float]:
        time.sleep(t.value)
        return x + y
...
def decorated_multiply() -> Callable:
    ...
    @task.calcfunction
    def multiply(x: Union[int, float], y: Union[int, float], t: Union[int, float] = 1.0) -> Union[int, float]:
        time.sleep(t.value)
        return x * y
