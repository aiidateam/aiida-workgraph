...
* :doc:`/advanced/autogen/context_manager`
   This section discusses the context manager paradigm, which simplifies workflow management by providing a structured way to handle task execution and resource management.
