...
def UseExclude(
    ...
    inputs: t.Annotated[
        dict,
        namespace(
            consume_complex1=t.Annotated[consume_complex.inputs, SocketSpecSelect(exclude='data.pw.structure')],
            consume_complex2=t.Annotated[consume_complex.inputs, SocketSpecSelect(exclude='data.pw.structure')],
        ),
    ],
):
