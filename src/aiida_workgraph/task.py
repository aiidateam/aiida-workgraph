...
class Task(GraphNode):
    ...
    def to_html(self, output: str = None, show_socket_depth: int | None = None, **kwargs):
...
class TaskSet:
    ...
    def _normalize_tasks(self, tasks: list[str | Task] | str | Task) -> Iterable[str]:
    ...
    def remove(self, tasks: list[str | Task] | str | Task) -> None:
