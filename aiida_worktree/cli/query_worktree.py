...
class WorkTreeQueryBuilder:
    """Utility class to construct a QueryBuilder instance for WorkTree nodes and project the query set."""
    ...
    def get_query_set(
        ...
        builder.append(
            WorkTree, filters=filters, project=unique_projections, tag="process"
        )
